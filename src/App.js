...
const quizQuestions = [
    ...
    {
        id: 4,
        text: '新しい建設技術について、あなたの考え方は？',
        choices: [
            {
                text: '積極的に学び、現場での活用方法を考える',
                score: 3,
                reaction: '向上心があって素晴らしい！新しい技術は現場を安全で効率的にするね！'
            },
            {
                text: '必要な技術だけ選んで取り入れる',
                score: 2,
                reaction: '実用性を重視する姿勢は大事だね！'
            },
            {
                text: '従来の方法の方が信頼できるので、あまり変えない',
                score: 1,
                reaction: '経験を大切にするのは良いけど、技術の進歩も大切だよ！'
            }
        ]
    },
    {
        id: 5,
        text: '現場で安全対策として最も重視することは？',
        choices: [
            {
                text: '日々の安全確認と作業前ミーティングの徹底',
                score: 3,
                reaction: '安全意識が高いね！丸洋建設の理念にぴったりだよ！'
            },
            {
                text: '適切な保護具の着用と定期的な点検',
                score: 2,
                reaction: '基本をしっかり守る姿勢、とても良いね！'
            },
            {
                text: '作業手順の明確化とマニュアルの遵守',
                score: 2,
                reaction: 'ルールを大切にする姿勢は現場では重要だね！'
            }
        ]
    }
];
