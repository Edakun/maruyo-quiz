        ...
        choices: [
            {
                ...
                score: 3,
                reaction: '向上心があって素晴らしい！常に学び続ける姿勢が大切です！'
            },
            {
                text: '同僚と一緒に勉強会を開き、チームで習得を目指す',
                score: 2,
                reaction: 'チームで学ぶ姿勢は素晴らしいですね！'
            },
            {
                text: '経験豊富な先輩に教えてもらいながら少しずつ覚える',
                score: 1,
                reaction: '謙虚さも大切ですが、自主性ももう少しあるとより良いかも！'
            }
        ]
    },
    {
        id: 5,
        text: '現場で安全対策について意見を求められた。あなたなら？',
        choices: [
            {
                text: '最新の安全基準と過去の事例を調査し、具体的な改善案を提案する',
                score: 3,
                reaction: '安全への意識が高く、しっかり準備する姿勢が素晴らしいです！'
            },
            {
                text: '日々の作業で気づいた危険箇所について具体的に報告する',
                score: 2,
                reaction: '現場での気づきを活かす姿勢、とても良いですね！'
            },
            {
                text: '安全第一を心がけ、基本的なルールを守ることを提案する',
                score: 1,
                reaction: '基本を大切にする姿勢は良いですね。もう少し具体的な提案があるとさらに良いかも！'
            }
        ]
    }
];
